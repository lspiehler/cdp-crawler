...
module.exports = function() {
    ...
    var createSession = function(params, credindex, cacheenabled, callback) {
        ...
        if(credindex < params.credentials.snmp.length) {
            let tempsession;
            let cached = false;
            if(params.credentialcache.hasOwnProperty(params.host) && params.credentialcache[params.host].snmp && cacheenabled) {
                cached = true;
                ...
                if(params.credentials.snmp[params.credentialcache[params.host].snmp].version == 2) {
                    tempsession = snmp.createSession(params.host, params.credentials.snmp[params.credentialcache[params.host].snmp].community);
                ...
                if(params.credentials.snmp[credindex].version == 2) {
                    tempsession = snmp.createSession(params.host, params.credentials.snmp[credindex].community);
